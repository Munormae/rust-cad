...
cryxtal_topology::prelude!(Point3, Curve, NurbsSurface<Vector4>);
...
fn create_fillet_surface() {
    ...
    let surface1 = BSplineSurface::new(
        ...
        KnotVec::bezier_knot(2),
        vec![
            [Point3::new(0.2, 0.0, 0.0),  Point3::new(0.0, 0.0, -0.5), Point3::new(-0.2, 0.0, -1.0)],
            [Point3::new(0.0, 0.5, 0.0),  Point3::new(0.0, 0.5, -0.5), Point3::new(0.0, 0.5, -1.0)],
            [Point3::new(-0.2, 1.0, 0.0), Point3::new(0.2, 1.0, -0.5), Point3::new(0.0, 1.0, -1.0)],
        ],
    );
