...
where
    ...
    S: StepLength,
{
    fn new(shell: &'a CmpShell<P, C, S>, idx: usize, is_open: bool) -> Self {
...
where
    ...
    S: StepLength,
{
    fn new(solid: &'a CmpSolid<P, C, S>, idx: usize) -> Self {
        let mut cursor = idx + 1;
...
impl<'a, P, C, S> From<&'a CmpShell<P, C, S>> for PreStepModel<'a, P, C, S>
where
    P: Copy,
    C: StepLength,
    S: StepLength,
...
impl<'a, P, C, S> From<&'a CmpSolid<P, C, S>> for PreStepModel<'a, P, C, S>
where
    P: Copy,
    C: StepLength,
    S: StepLength,
...
impl<'a, P, C, S> From<&'a CmpShell<P, C, S>> for StepModel<'a, P, C, S>
where
    P: Copy,
    C: StepLength,
    S: StepLength,
    ...
    S: StepLength,
{
    ...
    pub fn push_shell(&mut self, shell: &'a CmpShell<P, C, S>) {
    ...
    pub fn push_solid(&mut self, solid: &'a CmpSolid<P, C, S>) {
...
impl<'a, P, C, S> FromIterator<&'a CmpShell<P, C, S>> for StepModels<'a, P, C, S>
where
    P: Copy,
    C: StepLength,
    S: StepLength,
{
    fn from_iter<T: IntoIterator<Item = &'a CmpShell<P, C, S>>>(iter: T) -> Self {
        let mut next_idx = 16;
        let models = iter
            .into_iter()
            .map(|shell| {
...
impl<'a, P, C, S> FromIterator<&'a CmpSolid<P, C, S>> for StepModels<'a, P, C, S>
where
    P: Copy,
    C: StepLength,
    S: StepLength,
{
    fn from_iter<T: IntoIterator<Item = &'a CmpSolid<P, C, S>>>(iter: T) -> Self {
        let mut next_idx = 16;
        let models = iter
            .into_iter()
            .map(|solid| {
