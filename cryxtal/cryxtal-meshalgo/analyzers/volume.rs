...
/// Volume and center-of-gravity computation for meshes and solids.
pub trait CalcVolume {
    /// Returns oriented volume.
    fn volume(&self) -> f64;
    /// Returns weighted centroid (x,y,z,w) where w is 6*volume.
...
impl CalcVolume for cryxtal_topology::Solid<Point3, PolylineCurve<Point3>, PolygonMesh> {
    fn volume(&self) -> f64 {
        self.face_iter()
