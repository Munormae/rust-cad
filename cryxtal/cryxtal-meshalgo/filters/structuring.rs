...
/// Mesh structuring operations (triangulate, quadrangulate by merging triangles).
pub trait StructuringFilter {
    /// Convert the mesh to purely triangular faces.
    fn triangulate(&mut self) -> &mut Self;
    /// Merge triangles into quads by planarity/shape score thresholds.
