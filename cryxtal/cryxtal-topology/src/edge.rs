...
pub enum ConcatError<P: Debug> {
    ...
    SameVertex(Vertex<P>),
    #[error("{0}")]
    FromGeometry(cryxtal_geotrait::ConcatError<P>),
}

impl<P: Debug> From<cryxtal_geotrait::ConcatError<P>> for ConcatError<P> {
    fn from(err: cryxtal_geotrait::ConcatError<P>) -> ConcatError<P> {
